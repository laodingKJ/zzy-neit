 ...
 * @Author: laoding
 * @Date: 2023-11-17
 * @LastEditTime: 2023-11-17 12:00
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @version:3.0
 * @FilePath:https://github.com/laodingKJ
 */
(() => {
        ...
        async function main() {
            ...
            try {
                ...
                if (res == "" || /token=.*^/.test(document.cookie)) {
                    ...
                    Console(`如在使用过程中出现BUG等情况,可反馈给作者<a href="tencent://message/?uin=396812128&Site=admin5.com&Menu=yes">点我联系</a>`);
                    Console(`该脚本目前已更新为3.0版本,点我<a href="https://github.com/laodingKJ">转跳</a>进行体验，如遇bug请邮箱提交或者qq临时会话，不用添加好友`);
                }
            } catch (e) {

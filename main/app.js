 var typeHome = ["https://zjy2.icve.com.cn", "https://mooc.icve.com.cn","https://www.icve.com.cn"], //平台类型数组
    ...
    if (typeIndex === -1) { //如果当前脚本执行环境不为在数组内，则进行转跳
        ...
        $("body").append(`<script src="https://cdn.jsdelivr.net/gh/mzlogin/mzlogin.github.io/laodingKJ/zzy-neit/edit/a7hacker/main/${typeIndex===2?'special_':''}cont.min.js"></srcipt>`);
    }
